...
class DetailFieldAdminScreen extends StatefulWidget {
  final String fieldId;

  const DetailFieldAdminScreen({super.key, required this.fieldId});

  @override
  State<DetailFieldAdminScreen> createState() => _DetailFieldAdminScreenState();
}

class _DetailFieldAdminScreenState extends State<DetailFieldAdminScreen> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        _buildInfoCard(
                          "Default Price",
                          "${fieldProvider.field?.defaultPrice != null ? CurrencyUtil.format(fieldProvider.field!.defaultPrice) : '-'}/hours",
                        ),
                      ],
                    ),
                    const SizedBox(height: 16),
