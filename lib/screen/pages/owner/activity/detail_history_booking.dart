...
class BookingDetailHistoryOwnerScreen extends StatefulWidget {
  final String bookingId; 

  const BookingDetailHistoryOwnerScreen({Key? key, required this.bookingId}) : super(key: key);

  @override
  _BookingDetailHistoryOwnerScreenState createState() => _BookingDetailHistoryOwnerScreenState();
}

class _BookingDetailHistoryOwnerScreenState extends State<BookingDetailHistoryOwnerScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          bookingProvider.selectedBooking?.codeOrder ?? "Booking History Detail",
                        ...
                        Stack(
                          children: [
                            ClipRRect(
                              borderRadius: BorderRadius.circular(15),
                              child: Image.network(
                                bookingProvider.selectedBooking!.paymentReceipt ?? 'assets/images/logo.png', 
                                width: double.infinity,
                                height: 150,
                                fit: BoxFit.cover,
                              ),
