...
class BookingDetailHistoryOwnerScreen extends StatefulWidget {
  ...
  const BookingDetailHistoryOwnerScreen({super.key, required this.bookingId});

  @override
  State<BookingDetailHistoryOwnerScreen> createState() =>
      _BookingDetailHistoryOwnerScreenState();
}

class _BookingDetailHistoryOwnerScreenState
    extends State<BookingDetailHistoryOwnerScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          bookingProvider.selectedBooking?.codeOrder ??
